...
// zonesTimeline = [{time, highs:[...], lows:[...]} ...] sorted by time
...
export function detectMR({ h1, zonesTimeline, cfg = MR_CONFIG }) {
  ...
  let zIdx = 0;           // pointer in zones timeline
  let lastSellIdx = -999; // cooldown
  let lastBuyIdx = -999;
